...
Uses the same three-phase pipeline as SWE-Bench:
  1. Build shared builder image (SDK + dependencies)
  2. Build per-instance base images (SDK's base-image-minimal target)
  3. Assemble final agent images locally (Dockerfile.agent-layer)
...
from benchmarks.utils.build_utils import default_build_output_dir, get_build_parser
...
def build_commit0_images(
    *,
    ...
    builder_result = build_builder_image(push=push, force_build=force_build)
